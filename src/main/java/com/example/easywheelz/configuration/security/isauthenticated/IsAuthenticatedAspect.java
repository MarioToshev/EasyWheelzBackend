package com.example.easywheelz.configuration.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(com.example.easywheelz.configuration.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(com.example.easywheelz.configuration.security.isauthenticated.IsAuthenticated)")
